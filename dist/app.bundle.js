...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _throttleTime = __webpack_require__(401);
	...
	_Rx2.default.Observable.fromEvent(button, 'click').map(function (data) {
		(0, _throttleTime.throttleTime)(1000);
		return data.clientY;
	}).subscribe(function (event) {
		console.log(event);
	});
	var RxObservable = _Rx2.default.Observable.create(function (obs) {
	...
	_Rx2.default.Observable.create(function (obs) {
	...
	var inputObservable = _Rx2.default.Observable.fromEvent(input, 'input');
	inputObservable.map(function (event) {
		return event.target.value;
	}).debounceTime(500).distinctUntilChanged().subscribe(function (value) {
		console.log("hello world your seraching for " + value);
	});
	//scan and  reduce 


	var numberObservable = _Rx2.default.Observable.of(1, 2, 3, 4);

	numberObservable.reduce(function (sum, value) {
		return sum + value;
	}, 0).subscribe(function (value) {
		console.log(value);
	});
	var ScannumberObservable = _Rx2.default.Observable.of(1, 2, 3, 4);

	ScannumberObservable.scan(function (sum, value) {
		return sum + value;
	}, 0).subscribe(function (value) {
		console.log(value);
	});
